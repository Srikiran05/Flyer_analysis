-- ============================================================
-- FIX COMPETITOR PRICING RPCs: lowercase category matching
-- These 3 functions use fp.category = p_category (case-sensitive)
-- but p_category arrives title-cased ('Frozen Fries') while DB
-- stores lowercase ('frozen fries'). Fix: lower(p_category).
-- ============================================================
...
DECLARE
  v_categories TEXT[];
BEGIN
  -- Lowercase the categories array for matching
